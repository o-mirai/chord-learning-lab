...
export const CHORD_TYPES = {
  "major": { name: "メジャー", intervals: [0, 4, 7], suffix: "", degreeNotation: "(1, 3, 5)" },
  "minor": { name: "マイナー", intervals: [0, 3, 7], suffix: "m", degreeNotation: "(1, ♭3, 5)" },
  "seventh": { name: "セブンス", intervals: [0, 4, 7, 10], suffix: "7", degreeNotation: "(1, 3, 5, ♭7)" },
  "major7": { name: "メジャーセブンス", intervals: [0, 4, 7, 11], suffix: "maj7", degreeNotation: "(1, 3, 5, 7)" },
  "minor7": { name: "マイナーセブンス", intervals: [0, 3, 7, 10], suffix: "m7", degreeNotation: "(1, ♭3, 5, ♭7)" },
  "sus4": { name: "サスフォー", intervals: [0, 5, 7], suffix: "sus4", degreeNotation: "(1, 4, 5)" },
  "dim": { name: "ディミニッシュ", intervals: [0, 3, 6], suffix: "dim", degreeNotation: "(1, ♭3, ♭5)" },
  "aug": { name: "オーギュメント", intervals: [0, 4, 8], suffix: "aug", degreeNotation: "(1, 3, #5)" }
};
...
export function generateChordNotes(root, type) {
  ...
  if (root.includes('/')) {
    // シャープ表記を優先（例: "C#/Db" → "C#"）
    const sharpNote = root.split('/')[0];
    rootIndex = NOTE_MAP.indexOf(sharpNote);
  } else {
...
export const UI_MESSAGES = {
  ...
  MIDI_DISCONNECTED: 'MIDIデバイスが切断されました',
  MIDI_READY: 'MIDIデバイスを接続できます',
  SELECT_CHORD: 'コードを選んでください',
  CORRECT_PREFIX: '<svg class="icon icon-inline icon-check"><use href="#icon-check"></use></svg> 正解！',
  INCORRECT_PREFIX: '<svg class="icon icon-inline icon-x"><use href="#icon-x"></use></svg> 不正解。正解は',
  NO_CHORDS_SELECTED: 'コードを1つ以上選択してください',
  QUIZ_COMPLETE: 'クイズ完了！',
  TIME_TAKEN: 'かかった時間: '
};
